...
- Evening-results and nightly-learning timers are enabled and active. The morning timer is enabled and will be started automatically at 00:05 on 6 September, avoiding a persistent replay of the already-completed 5 September morning run.
