...
function raceCompareHtml(race, selectedHorse) {
  ...
  runners.forEach(function(runner, idx) {
    ...
    html += '<span class="race-horse-runner" style="--target:' + score + '%;--dur:' + Math.max(7, Math.round(5 + score / 7)) + 's"><svg class="horse-gallop-icon" viewBox="0 0 64 40" aria-hidden="true" focusable="false"><path class="horse-tail" d="M13 17 C5 11 3 21 10 25 C9 20 11 18 16 19 Z"></path><path class="horse-body" d="M16 17 C23 10 37 10 46 17 L51 14 C56 12 60 16 59 21 L57 25 L51 24 L48 21 C41 25 27 25 18 22 C15 21 14 19 16 17 Z"></path><path class="horse-neck" d="M43 14 C48 7 55 6 58 11 C55 11 53 13 52 16 L47 20 Z"></path><path class="horse-head" d="M53 8 C59 8 63 12 62 17 C61 20 57 20 54 18 C52 17 51 14 53 8 Z"></path><path class="horse-ear" d="M55 8 L57 2 L59 9 Z"></path><circle class="horse-eye" cx="58" cy="13" r="1.2"></circle><path class="horse-leg leg-front-a" d="M46 22 L53 34"></path><path class="horse-leg leg-front-b" d="M42 22 L37 35"></path><path class="horse-leg leg-back-a" d="M24 22 L18 35"></path><path class="horse-leg leg-back-b" d="M29 22 L36 34"></path></svg></span>';
