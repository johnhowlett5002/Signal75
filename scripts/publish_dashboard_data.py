...
def challenger_lab_feed() -> dict:
    ...
    for row in summary.get("pre_race_challengers", []) or []:
        ...
        challengers.append({
            ...
            "roiReadyDays": row.get("settled_days", 0),
            "accountingSettledDays": row.get("accounting_settled_days", row.get("settled_days", 0)),
            "retrospectiveSeedDays": row.get("retrospective_seed_days", 0),
